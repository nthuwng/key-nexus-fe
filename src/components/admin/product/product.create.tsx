import { createProductAPI } from "@/service/admim/createAPI";
import { fetchCategoryAPI, fetchCategoryIdAPI } from "@/service/admim/fetchAPI";
...
const CreateProduct =(props :IProps) => {
    ...
    const onFinish: FormProps<FieldType>['onFinish']= async (values) =>
    {
        ...
        setIsSubmit(true)
        const res= await createProductAPI(name,price,quantity,image,brand,categoryId,);
        if(res &&res.data)
        {
