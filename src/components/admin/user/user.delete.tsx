import { deleteProductAPI, deleteUserAPI } from "@/service/admim/deleteAPI";
...
import { useEffect, useState } from "react";
    ...
    refreshTable: ()=> void;
    setDataDelete: (v: IUserTable| null)=> void;
    dataDelete: IUserTable| null
}
type FieldType ={
      _id: string;
    name: string;
